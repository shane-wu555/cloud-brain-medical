...
export interface Doctor{id:string;employeeNo:string;name:string;title:string;departmentId:string;departmentName:string;specialty:string;roleType:string}
...
export async function createDoctor(payload:{employeeNo:string;name:string;title:string;departmentId:string;roleType:string;specialty:string}){return(await http.post<Doctor>('/doctors',payload)).data;}
