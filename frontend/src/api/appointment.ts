...
export interface Appointment { id:string;businessNo:string;scheduleId:string;patientId:string;patientName:string;doctorId:string;doctorName:string;departmentId:string;departmentName:string;visitDate:string;period:string;source:string;status:string;paymentStatus:string;paymentMethod?:string;triageSummary:string;riskLevel:string;recommendedDepartmentId?:string;queueNumber:number;missedCount:number;createdAt:string }
